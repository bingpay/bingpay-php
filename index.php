...
require_once './bingpay-php/vendor/autoload.php';


require_once './bingpay-php/src/BingPay/Connection.php';
require_once './bingpay-php/src/BingPay/Wallet.php';
require_once './bingpay-php/src/BingPay/Airtime.php';
require_once './bingpay-php/src/BingPay/Bank.php';
require_once './bingpay-php/src/BingPay/Data.php';
require_once './bingpay-php/src/BingPay/Trade.php';
require_once './bingpay-php/src/BingPay/Utility.php';
require_once './bingpay-php/src/BingPay/Verify.php';
